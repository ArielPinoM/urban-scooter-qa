# US-12: Si "Estación de metro" está vacía, al intentar avanzar se muestra error "Introduce un Estación de metro correcto".
...
### Resultado esperado
Muestra mensaje de error “Introduce un estación de metro correcto”.
